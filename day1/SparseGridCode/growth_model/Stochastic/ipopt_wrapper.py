...
def EV_F_ITER(X, k_init, n_agents, grid):
    ...
    # Compute Value Function
    #grid.evaluate(knext) gives value of value function at point k'
...
#I THINK THIS IS JUST MARKET CLEARING
...
def EV_G(X, k_init, n_agents):
    ...
    f_prod=output_f(k_init, lab,inittheta)
